...
const AgentApplication = () => {
  ...
  // Prefill form with user data when userDetails loads
  useEffect(() => {
    if (userDetails) {
      setFormData(prev => ({
        ...prev,
        fullName: userDetails.firstName && userDetails.lastName 
          ...
          : userDetails.firstName || currentUser?.displayName || '',
  ...
  // Redirect agent users to the agent dashboard
  useEffect(() => {
  ...
  useEffect(() => {
    if (!currentUser) {
      navigate('/login?redirect=agent-application');
    }
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="mb-6">
                      ...
                      />
                      {userDetails && formData.phoneNumber && (
                        <p className="mt-1 text-sm text-emerald-600">
                          ✓ Prefilled from your profile
                        </p>
                      )}
